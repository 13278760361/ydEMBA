...
class SignController extends BaseController {
    ...
    public function index(){
          ...
          $user_info =  $this->db->table('dk_students s ,dk_class c,dk_class_years cy')->field("s.headimgurl,s.username,s.phone,s.sex,cy.year_name,c.class_name")->where("s.class_id = c.id and c.class_year_id = cy.id and s.id ={$this->user_id}")->find();
