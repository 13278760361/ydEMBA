	...
	public function index(){
      ...
      foreach ($list as $key => $value) {
         ...
         if($class_year==''||$class_name_arr['class_name']==''){
          ...
          $list[$key]['class_name'] = $class_year.'级'.$class_name_arr['class_name'];
         }
      }
      //print_r($list);die;
      int_to_string($list);
...
//print_r($data);die;
   ...
   if(isset($_POST['class_id'])&&$_POST['class_id']!=''){
      ...
      foreach ($data as $k => $v) {
          if($v['id']==$_POST['class_id']){
            $str .= '<option value='.$v['id'].' selected class="year_'.$v['class_year_id'].'">'.$v['class_name'].'级</option>';
            }else{
            $str .= '<option value='.$v['id'].' class="year_'.$v['class_year_id'].'">'.$v['class_name'].'级</option>';
           }
         }
  ...
  public function choice_subjects(){
    ...
    foreach ($list as $key => $value) {
       ...
       $list[$key]['subject_score'] = floor($subject['subject_score']);
