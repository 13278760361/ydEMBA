...
<body>
    ...
    <form action="<?php echo U('Admin/SubjectsExp/exp_students_subject');?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">课程名称</label>
            <div class="controls">
            <select name="subject_id" id="subject_id">
				<option name="" value="0">请选择</option>
				<?php if(is_array($sb_list)): $i = 0; $__LIST__ = $sb_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name="" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["subject_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
		...
		<div class="form-item">
            ...
            <select name="years_id" id="years_id">
				...
				<?php if(is_array($year_list)): $i = 0; $__LIST__ = $year_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name="" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["year_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
                <!-- <input type="text" class="text" name="subject_name"> -->
