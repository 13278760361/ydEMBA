    ...
    <form action="<?php echo U('Students/edit');?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <select name="year_id" id="year" onchange="YearChange()">
              <option>请选择</option>
             <?php if(is_array($year)): foreach($year as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($data['year_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo ($v['year_name']); ?>级</option><?php endforeach; endif; ?>  

            </select> 

            <select name="class_id" id="class">
            <option>请选择</option>
              <?php if(is_array($class)): foreach($class as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" class="year_<?php echo ($v['class_year_id']); ?>"><?php echo ($v['class_name']); ?>级</option><?php endforeach; endif; ?>
            </select>
