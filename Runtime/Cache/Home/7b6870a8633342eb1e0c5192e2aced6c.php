...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Home/css/UIPickerView.css">
    ...
    <style>
        ...
        .number-icon{
            background:url('/Public/Home/image/number.svg') no-repeat left center;background-size: 18px;}
...
<body>
    ...
    <div class="bind-btn" poster="info" action="/index.php?s=Home/Public/login.html">
        绑定
    </div>
    <!--  班级列表 -->
    ...
    <script type="text/javascript" src="/Public/Home/js/UIPickerView.js"></script>
    <script type="text/javascript" src="/Public/Home/js/CAAnimation.js"></script>
    <script>
 var pickerCreate = document.getElementById('choice-course');
            ...
            var classObject="<?php echo ($classData); ?>";
